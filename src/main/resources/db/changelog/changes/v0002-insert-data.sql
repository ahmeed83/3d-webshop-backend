...
VALUES ('54567654', current_timestamp, null, 'Macbook 15', 315, 15, 1);

INSERT INTO threed.product(code, created_at, updated_at, description, price, quantity, category_id)
VALUES ('1223243', current_timestamp, null, 'DELL', 200, 15, 2);

INSERT INTO threed.product(code, created_at, updated_at, description, price, quantity, category_id)
VALUES ('098433232', current_timestamp, null, 'IPHONE 11', 700, 90, 3);
